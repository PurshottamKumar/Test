...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {maxRows: 4, log: function () { markerClassName: "hasDatepicker",
                ...
                for (var Z = 0; Z < X; Z++) {
                    ...
                    for (var S = 0; S < 7; S++) {
                    	...
                    	if(languageSearch == "ba"){
                    		//alert("IN FOR YEAR else ba");
                        	var ba = F ? F.apply(a.input ? a.input[0] : null, [Y]) : [!0, ""], bb = Y.getMonth() != n, bc = bb && !H || !ba[0] || l && Y < l || m && Y > m;
                            _ += '<td class="' + ((S + y + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (bb ? " ui-datepicker-other-month" : "") + (Y.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent || J.getTime() == Y.getTime() && J.getTime() == O.getTime() ? " " + this._dayOverClass : "") + (bc ? " " + this._unselectableClass + " ui-state-disabled" : "") + (bb && !G ? "" : " " + ba[1] + (Y.getTime() == k.getTime() ? " " + this._currentClass : "") + (Y.getTime() == b.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!bb || G) && ba[2] ? ' title="' + ba[2] + '"' : "") + (bc ? "" : ' onclick="DP_jQuery_' + dpuuid + ".datepicker._selectDay('#" + a.id + "'," + Y.getMonth() + "," + Y.getFullYear() + ', this);return false;"') + ">" + (bb && !G ? "&#xa0;" : bc ? '<span class="ui-state-default">' + mrt(Y.getDate()) + "</span>" : '<a class="ui-state-default' + (Y.getTime() == b.getTime() ? " ui-state-highlight" : "") + (Y.getTime() == k.getTime() ? " ui-state-active" : "") + (bb ? " ui-priority-secondary" : "") + '" href="#">' + mrt(Y.getDate()) + "</a>") + "</td>", Y.setDate(Y.getDate() + 1), Y = this._daylightSavingAdjust(Y)
                        }else if(languageSearch == undefined || languageSearch == null){
                        	//alert("IN FOR YEAR");
                        	var ba = F ? F.apply(a.input ? a.input[0] : null, [Y]) : [!0, ""], bb = Y.getMonth() != n, bc = bb && !H || !ba[0] || l && Y < l || m && Y > m;
                            _ += '<td class="' + ((S + y + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (bb ? " ui-datepicker-other-month" : "") + (Y.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent || J.getTime() == Y.getTime() && J.getTime() == O.getTime() ? " " + this._dayOverClass : "") + (bc ? " " + this._unselectableClass + " ui-state-disabled" : "") + (bb && !G ? "" : " " + ba[1] + (Y.getTime() == k.getTime() ? " " + this._currentClass : "") + (Y.getTime() == b.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!bb || G) && ba[2] ? ' title="' + ba[2] + '"' : "") + (bc ? "" : ' onclick="DP_jQuery_' + dpuuid + ".datepicker._selectDay('#" + a.id + "'," + Y.getMonth() + "," + Y.getFullYear() + ', this);return false;"') + ">" + (bb && !G ? "&#xa0;" : bc ? '<span class="ui-state-default">' + Y.getDate() + "</span>" : '<a class="ui-state-default' + (Y.getTime() == b.getTime() ? " ui-state-highlight" : "") + (Y.getTime() == k.getTime() ? " ui-state-active" : "") + (bb ? " ui-priority-secondary" : "") + '" href="#">' + mrt(Y.getDate()) + "</a>") + "</td>", Y.setDate(Y.getDate() + 1), Y = this._daylightSavingAdjust(Y)
                        }
                        else{
                        	//f//alert("IN FOR YEAR else");
                        	var ba = F ? F.apply(a.input ? a.input[0] : null, [Y]) : [!0, ""], bb = Y.getMonth() != n, bc = bb && !H || !ba[0] || l && Y < l || m && Y > m;
        ...
        if ((f || !i) && languageSearch == "ba" ){m += '<span class="ui-datepicker-month">' + g[b] + "</span>";}
        else if(languageSearch != "ba"){
        	//alert("dsads")
        	var n = d && d.getFullYear() == c, o = e && e.getFullYear() == c;
            m += '<select class="ui-datepicker-month" onchange="DP_jQuery_' + dpuuid + ".datepicker._selectMonthYear('#" + a.id + "', this, 'M');\" " + ">";
            for (var p = 0; p < 12; p++)(!n || p >= d.getMonth()) && (!o || p <= e.getMonth()) && (m += '<option value="' + p + '"' + (p == b ? ' selected="selected"' : "") + ">" + h[p] + "</option>");
        	...
        	//alert("language search else part")
        	var n = d && d.getFullYear() == c, o = e && e.getFullYear() == c;
            m += '<select class="ui-datepicker-month" onchange="DP_jQuery_' + dpuuid + ".datepicker._selectMonthYear('#" + a.id + "', this, 'M');\" " + ">";
            for (var p = 0; p < 12; p++)(!n || p >= d.getMonth()) && (!o || p <= e.getMonth()) && (m += '<option value="' + p + '"' + (p == b ? ' selected="selected"' : "") + ">" + h[p] + "</option>");
            m += "</select>"
        ...
        if (!a.yearshtml) {
            ...
            if ((f || !j) && languageSearch == "ba"){l += '<span class="ui-datepicker-year">' + c + "</span>";}
            else
            	if(languageSearch != "ba"){
            	 var q = this._get(a, "yearRange").split(":"), r = (new Date).getFullYear(), s = function (a) {
	                    var b = a.match(/c[+-].*/) ? c + parseInt(a.substring(1), 10) : a.match(/[+-].*/) ? r + parseInt(a, 10) : parseInt(a, 10);
	                ...
	                t = d ? Math.max(t, d.getFullYear()) : t, u = e ? Math.min(u, e.getFullYear()) : u, a.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + dpuuid + ".datepicker._selectMonthYear('#" + a.id + "', this, 'Y');\" " + "><optgroup style='font-size:1em;'>";
	                //for (t = 1900; t <= 2050; t++)
	                for (; t <= u; t++)a.yearshtml += '<option value="' + t + '"' + (t == c ? ' selected="selected"' : "") + ">" + t + "</option>";
	                a.yearshtml += "</optgroup></select>", l += a.yearshtml, a.yearshtml = null
            }
            else {
                var q = this._get(a, "yearRange").split(":"), r = (new Date).getFullYear(), s = function (a) {
                    var b = a.match(/c[+-].*/) ? c + parseInt(a.substring(1), 10) : a.match(/[+-].*/) ? r + parseInt(a, 10) : parseInt(a, 10);
...
jQuery(function ($) {
//alert("xmsdjb")	
	$.datepicker.regional['en-EN'] = {"Name": "en-EN", "closeText": "Close", "prevText": "Prev", "nextText": "Next", "currentText": "Today", "monthNames": ["JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER", ""], "monthNamesShort": ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC", ""], "dayNames": ["SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY"], "dayNamesShort": ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"], "dayNamesMin": ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"], "dateFormat": "dd-mm-yy", "firstDay": 1, "isRTL": false};
...
function convertMonthIntoNumber(enteredMonth)
{
	
		var newDate="";
		if( "January" == (enteredMonth))
		{
			newDate=1;	
		}
		else if( "February" == (enteredMonth))
		{
			newDate=2;	
		}	else if("March" == (enteredMonth))
		{
			newDate=3;	
		}	else if("April" == (enteredMonth))
		{
			newDate=4;	
		}	else if("May" == (enteredMonth))
		{
			newDate=5;	
		}	else if( "June" == (enteredMonth))
		{
			newDate=6;	
		}	else if( "July" == (enteredMonth))
		{
			newDate=7;	
		}	else if("August" == (enteredMonth))
		{
			newDate=8;	
		}	else if( "September" == (enteredMonth))
		{
			newDate=9;	
		}	else if( "October"==(enteredMonth))
		{
			newDate=10;	
		}	else if( "November" == (enteredMonth))
		{
			newDate=11;	
		}	else if( "December" == (enteredMonth))
		{
			newDate=12;	
		}
...
var elid;
function checkDatePickerText(e){
	/*var str = $("#"+id).val();
	if(str.search('undefined') != -1){
		$("#"+id).val("");
	}*/
	
	elid = $(document.activeElement).hasClass('datePickerEnBn');
	console.log("elid === elid"+elid);
	
	$(".datePickerEnBn").keydown(function(e) {
		if (e.keyCode === 8 && !elid) {
	        return false;
	    }
	    if (e.keyCode === 46 && !elid) {
	        return false;
	    };
	    if (e.keyCode == 32 && !elid) {
	    	return false;
	    }
	    if (e.keyCode >= 48 && !elid) {
	 	   return false;
	    }
	...
	/*$(document).keydown(function(e) {
       console.log(e.keyCode + ' && ' + elid+"	 e.which 	"+e.which);
...
function convertNumberIntoMonth(enteredMonth)
{
		debugger
		var newDate="";
		if( 1 == (enteredMonth))
		...
		else if( 2 == (enteredMonth))
		{
			newDate="February";	
		}	else if(3 == (enteredMonth))
		{
			newDate="March";	
		}	else if(4 == (enteredMonth))
		{
			newDate="April";	
		}	else if(5 == (enteredMonth))
		{
			newDate="May";	
		}	else if( 6 == (enteredMonth))
		{
			newDate="June";	
		}	else if( 7 == (enteredMonth))
		{
			newDate="July";	
		}	else if(8 == (enteredMonth))
		{
			newDate="August";	
		}	else if( 9 == (enteredMonth))
		{
			newDate="September";	
		}	else if( 10==(enteredMonth))
		{
			newDate="October";	
		}	else if( 11 == (enteredMonth))
		{
			newDate="November";	
		}	else if( 12 == (enteredMonth))
		{
			newDate="December";	
		}
