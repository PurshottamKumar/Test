...
function _fnAssignDate(iIndex, sDay)
{
	...
	var pageView = $("#ssnPgVal").val();
				...
				var loanOrderDate = $("#loanOrderDate").val();
				
			
				/*var loanDate = $("#loanDate").val();*/
				var bankName = $("#bankId option:selected").text();
				if(loanAmount ==""){
					alert("कृपया  	ऋण की राशि भरे|");
				
				}
				if(bandhakArea =="" || bandhakArea ==undefined ){
					bandhakArea="0.000";
				}
				if(bankAddress !="" &&  loanDate!="" && loanAmount!=""){
					var rmrk ="";
					//rmrk = "राशि रू."+loanAmount+".00 में  इस भूमि का 0"+ bandhakArea+ " क्षेत्रफल " +bankName+" के शाखा "+ bankAddress+ " में दिनांक " +sDateString2+  " से  बंधक हैं |";
					rmrk = "राशि रू."+loanAmount+".00 में  इस भूमि का "+bandhakArea+ " क्षेत्रफल " +bankName+" के शाखा "+ bankAddress+ " में दिनांक " +sDateString2+  " से  बंधक हैं |";
					$('#remark').val(rmrk);
			      }
				if(orderNo !="" && orderBy != ""){
					
						var rmrk ="";
						rmrk = orderBy+" आदेश संख्या "+orderNo+" दिनांक "+sDateString+" के अनुसार मिटटी का वर्गीकरण संशोधित किया गया|";
						//						rmrk = orderBy+"(मिटटी वर्गीकरण) "+" दवारा प्रकरण क्रमांक "+orderNo+" दिनांक "+sDateString+" को की गई |";
