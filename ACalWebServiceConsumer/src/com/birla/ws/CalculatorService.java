 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.birla.com/", wsdlLocation = "https://localhost:8443/ACalWebServiceProvider/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.birla.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://localhost:8443/ACalWebServiceProvider/service?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.birla.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.birla.com/", "CalculatorPort"), Calculator.class, features);
    }
