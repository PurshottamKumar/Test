...
public class ObjectFactory {
    ...
    private final static QName _GetMsg_QNAME = new QName("http://test.com/", "getMsg");
    private final static QName _GetMsgResponse_QNAME = new QName("http://test.com/", "getMsgResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "getMsg")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "getMsgResponse")
