 ...
 * 
 */
@WebServiceClient(name = "MessageService", targetNamespace = "http://test.com/", wsdlLocation = "http://localhost:7878/test?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MESSAGESERVICE_QNAME = new QName("http://test.com/", "MessageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7878/test?wsdl");
    ...
    public Message getMessagePort() {
        return super.getPort(new QName("http://test.com/", "MessagePort"), Message.class);
    }
    ...
    public Message getMessagePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "MessagePort"), Message.class, features);
    }
