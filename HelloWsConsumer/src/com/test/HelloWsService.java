 ...
 * 
 */
@WebServiceClient(name = "HelloWsService", targetNamespace = "http://test.com/", wsdlLocation = "http://localhost:1212/HelloWsTest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://test.com/", "HelloWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1212/HelloWsTest?wsdl");
    ...
    public HelloWs getHelloWsPort() {
        return super.getPort(new QName("http://test.com/", "HelloWsPort"), HelloWs.class);
    }
    ...
    public HelloWs getHelloWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "HelloWsPort"), HelloWs.class, features);
    }
